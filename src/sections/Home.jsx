...
const SkeletonBox = ({ className = "" }) => (
  <div className={`animate-pulse bg-white/30 rounded ${className}`} />
);
...
const Home = () => {
  ...
  const provide = [
    ...
    {
      tag: "Women and Kid Safety Solutions",
      logo: (
        <svg
          width="20"
          height="20"
    ...
    {
      tag: "Project Consultancy and Skill building internships",
      logo: (
        <svg
          width="20"
          height="20"
            ...
            <div className="col-span-12 sm:col-span-6 xl:col-span-7">
              <div className="grid xl:grid-cols-2 gap-4">
                <div className="bg-white/50 overflow-y-auto h-full max-h-[155px] sm:max-h-full flex flex-col gap-2 justify-between rounded-lg p-5">
                  ...
                  {isLoading
                    ? Array(5)
                        .fill(0)
                        .map((_, i) => (
                          <SkeletonBox key={i} className="h-[40px] w-full" />
                        ))
                ...
                <div className="hidden xl:flex h-full flex-col gap-4">
                  {/* Image 3 with lazy and skeleton */}
                  <div className="h-1/2 rounded-lg text-[#0F75BC] flex flex-col justify-center items-center relative">
                    ...
                    <img
                      ...
                      className="aspect-square max-h-[250px] rounded-lg object-cover w-full relative z-10"
                    />
                  </div>
                  {/* Image 1 with lazy and skeleton */}
